    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      >
        <div className="max-w-sm text-center">
          ...
          <h2 className="text-2xl font-bold mb-4 leading-snug">Din AI-assistent for håndværkere</h2>
          <p className="text-white/70 leading-relaxed">
            Diktér en opgave. Få tilbud, projektplan og koordinering — på få minutter.
          </p>
          <div className="mt-10 space-y-3 text-left text-sm text-white/70">
            {['Tilbud på 5 minutter', 'Professionel PDF-eksport', 'Projektplan med ét klik'].map(f => (
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-8 bg-slate-50">
        <div className="w-full max-w-sm">
          <h1 className="text-2xl font-bold text-slate-900 mb-1">Log ind</h1>
          <p className="text-slate-500 text-sm mb-8">Velkommen tilbage til Aison.</p>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            Ingen konto?{' '}
            <button onClick={onSwitchToRegister} className="font-semibold" style={{ color: '#E67E22' }}>
              Opret konto
            </button>
          </p>
        </div>
